...
public interface PayInfoRpcService {
   ...
   * @return
   */
  PayOrderResponse payString(@JsonRpcParam("consultId") String consultId, @JsonRpcParam("orderId") int payWay);

  PayOrderResponse payGo(@JsonRpcParam("orderId") OrderPayRequest request);
   ...
   */
  PayOrderResponse queryCoin(@JsonRpcParam("patientId") Long patientId, @JsonRpcParam("doctorId") Long doctorId);
