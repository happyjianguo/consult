...
//import com.jkys.consult.shine.bean.OrderInfoDO;
//import com.jkys.consult.shine.bean.PatientAdvisoryOrder;
...
//        Long userId = ApiGateway.getUserId();
//        String startDate = DateUtils.getFirstDayOfMonth(request.getDate());
//        String endDate = DateUtils.getFirstDayOfNextMonth(request.getDate());
